SELECT
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.chave_codigo,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.chave_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.id_produto_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.descricao_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.unidade_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.id_emitente_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.id_destinatario_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.codigo_municipio_destinatario_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.data_emissao_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.data_fabricacao_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.data_validade_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.lote_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.quantidade_lote_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.nota_cancelada_devolucao,
	MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_VALORES.quantidade_devolucao
FROM (
SELECT
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
) AS MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS
...
) AS MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_VALORES
	ON MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.chave_codigo = MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_VALORES.chave_codigo
	AND MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.chave_devolucao = MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_VALORES.chave_devolucao
ORDER BY MEDICAMENTOS_DEVOLVIDOS_REFERENCIADOS_DADOS.chave_devolucao;